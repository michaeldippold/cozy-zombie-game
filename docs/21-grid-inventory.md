...
## Consumables from containers (2026-09-17)

Michael: eating and drinking should work straight from an open container or body, so a bag of chips on a zombie can be eaten without taking up bag space. Planks and the like still have to be carried to be useful. Built: Eat and Drink appear in the menu of any bag; Equip and Toggle only in the backpack.
